            ...
            return {
                ...
                'handler': function() {
                    ...
                    if (sfhub.events[eventName]) {
                        for (n = 0; n < l; n++) {
                            try {
                                args.push((argsList[n] && arguments[n] && arguments[n].length > 0) ? JSON.parse(arguments[n]) : arguments[n]);
                            } catch (e) {
