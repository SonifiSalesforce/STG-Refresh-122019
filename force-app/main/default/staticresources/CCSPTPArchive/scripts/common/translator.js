        var translator = (function() {
            ...
            var staticText = {
                'agentStatusTabTitle': 'SFDC info',
                'touchPointTabTitle': 'TouchPoint',
                'agentStatusLegend': 'Agent Status',
                'agentNameFieldTitle': 'Name',
                'callInfoLegend': 'Call Info',
                'mediaFieldTitle': 'Media',
                'directionFieldTitle': 'Direction',
                'stateFieldTitle': 'State',
                'fromFieldTitle': 'From',
                'toFieldTitle': 'To',
                'pageSyncBtn': 'Page Sync',
                'callDetailsBtn': 'Call Details',
                'queueFieldTitle': 'Queue',
                'callerNameFieldTitle': 'Caller Name',
                'callIDFieldTitle': 'CallID',
                'saveLogBtn': 'Save log for call from ',
                'traceFieldTitle': 'trace ',
                'offFieldTitle': 'off',
                'onFieldTitle': 'on',
                'dialLegend': 'Dial',
                'errorIndicatorPopupText': 'Probably an error in the softphone javascript. Turn the trace log on to check the error.',
                'okBtn': 'OK',
                'moreBtn': 'More',
                'saveLogAlertText': 'Call log can\'t be related to current object. Please select object (such as Account, Customer, etc.) relevant to this call and click retry button in softphone panel.',
                'syncAlertText': 'Current page is not related to any object and can not be synchronized. Please open page related to object you want to transfer to another agent.',
                'extensionFieldTitle': 'Agent extension'
            }
            ...
            function translateStaticText(key) {
                var tranlsation = staticText[key];
                return tranlsation || key;
            }

            function onLoad() {
                console.log('Translating all translatible texts...');
                $(".translatible").each(function(index) {
                    $(this).text(translator.translateStaticText($(this).data('trn-id')));
                });
            }
            ...
            return {
                ...
                translateStaticText: translateStaticText,
                onLoad: onLoad
            }
        })();